//! Shared SHA-512 compression core (FIPS 180-2).
//!
//! The 64-bit SHA-2 compression function and its round constants, used by both
//! [`Sha512Digest`](crate::sha512::Sha512Digest) and
//! [`Sha384Digest`](crate::sha384::Sha384Digest) — they differ only in their
...
/// Compresses one 128-byte big-endian block into the eight working registers `h`
/// (bc `LongDigest.ProcessBlock`).
