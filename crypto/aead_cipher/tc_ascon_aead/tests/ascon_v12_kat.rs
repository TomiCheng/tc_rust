use tc_ascon_aead::legacy::{
    Engine, KEY_BYTES_80PQ, KEY_BYTES_128, NONCE_BYTES, Params, TAG_BYTES, Variant,
};
...
const VARIANTS: [Variant; 3] = [Variant::Ascon128, Variant::Ascon128a, Variant::Ascon80pq];
...
#[test]
fn chunked_and_initial_aad_processing_match_vectors() {
    for variant in VARIANTS {
