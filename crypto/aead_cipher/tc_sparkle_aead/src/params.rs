//! Convenience SCHWAEMM parameters.

use core::fmt;

use tc_params::{InitialAadParams, IvParams, KeyParams};

/// Borrowed SCHWAEMM initialization parameters.
///
/// This type does not copy or validate its inputs. [`Engine`](crate::Engine)
/// validates their lengths for the selected [`Variant`](crate::Variant)
