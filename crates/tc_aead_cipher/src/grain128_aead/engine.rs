...
use super::{KEY_BYTES, NONCE_BYTES, Params, TAG_BYTES};
...
/// AAD length must be declared through [`Params::aad_len`] during
...
impl AeadCipherInit for Engine {
    ...
    fn init(
        ...
        self.nonce.copy_from_slice(params.nonce());
        self.lfsr.fill(0);
        self.nfsr.fill(0);
        self.auth.fill(0);
        self.tag_buffer.fill(0);
        ...
        self.process_aad_bytes(initial_aad)
    }
}
