//! Static tables for the generalised Rijndael engine (verbatim from Bouncy
//! Castle's `RijndaelEngine`).

/// GF(2^8) logarithm table (base of the generator used by the reference code).
#[rustfmt::skip]
pub(super) const LOG: [u8; 256] = [
...
/// GF(2^8) antilogarithm table, doubled (511 entries) so the multiply helpers
/// can index `offset + log` without a modular reduction.
#[rustfmt::skip]
pub(super) const ALOG: [u8; 511] = [
...
/// The Rijndael S-box (forward substitution).
#[rustfmt::skip]
pub(super) const S: [u8; 256] = [
...
/// The inverse Rijndael S-box.
#[rustfmt::skip]
pub(super) const SI: [u8; 256] = [
...
#[rustfmt::skip]
pub(super) const RCON: [u8; 30] = [
    0x01, 0x02, 0x04, 0x08, 0x10, 0x20, 0x40, 0x80, 0x1b, 0x36, 0x6c, 0xd8, 0xab, 0x4d, 0x9a,
    0x2f, 0x5e, 0xbc, 0x63, 0xc6, 0x97, 0x35, 0x6a, 0xd4, 0xb3, 0x7d, 0xfa, 0xef, 0xc5, 0x91,
];

/// Row-shift distances (bits) for encryption, indexed by `(block_bits - 128) / 32`.
pub(super) const SHIFTS0: [[u32; 4]; 5] = [
    [0, 8, 16, 24],
    [0, 8, 16, 24],
    [0, 8, 16, 24],
    [0, 8, 16, 32],
...
/// Row-shift distances (bits) for decryption.
pub(super) const SHIFTS1: [[u32; 4]; 5] = [
    [0, 24, 16, 8],
    [0, 32, 24, 16],
    [0, 40, 32, 24],
    [0, 48, 40, 24],
