...
use common::unhex;
use tc_block_cipher::{
    BlockCipher, BlockCipherInit, BlockError, CipherDirection, InitError, KeyParams, KeyRef,
};
use tc_dstu7624_v2::{Dstu7624Engine128, Dstu7624Engine256, Dstu7624Engine512};
...
#[test]
fn kalyna_128_with_a_128_bit_key_matches_the_known_answer_in_both_directions() {
    run_vector(
        Dstu7624Engine128::new(),
...
#[test]
fn kalyna_128_with_a_256_bit_key_matches_the_known_answer_in_both_directions() {
    run_vector(
        Dstu7624Engine128::new(),
...
#[test]
fn kalyna_256_with_a_256_bit_key_matches_the_known_answer_in_both_directions() {
    run_vector(
        Dstu7624Engine256::new(),
        "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F",
...
#[test]
fn kalyna_256_with_a_512_bit_key_matches_the_known_answer_in_both_directions() {
    run_vector(
        Dstu7624Engine256::new(),
...
#[test]
fn kalyna_512_with_a_512_bit_key_matches_the_known_answer_in_both_directions() {
    run_vector(
        Dstu7624Engine512::new(),
        "000102030405060708090A0B0C0D0E0F101112131415161718191A1B1C1D1E1F202122232425262728292A2B2C2D2E2F303132333435363738393A3B3C3D3E3F",
