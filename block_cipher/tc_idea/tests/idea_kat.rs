...
use tc_idea_v2::{BLOCK_BYTES, IdeaEngine};
...
#[test]
fn the_bouncy_castle_multiblock_vectors_match_in_both_directions() {
    run_vector(
...
#[test]
fn the_reference_idea_vector_matches_in_both_directions() {
    run_vector(
