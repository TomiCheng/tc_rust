...
fn run<E>(
    ...
    for<'a> E: BlockCipherInit<dyn tc_rc5_v2::Rc5Params + 'a, Error = InitError>,
{
    let key = unhex(key);
    let iv = unhex(iv);
...
#[test]
fn rc5_32_matches_all_cbc_derived_known_answers_in_both_directions() {
    run32(
        0,
        "00",
        "0000000000000000",
...
#[test]
fn rc5_64_matches_all_cbc_derived_known_answers_in_both_directions() {
    run64(
        0,
        "00",
