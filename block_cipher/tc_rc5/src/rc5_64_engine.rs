...
use crate::{MAX_KEY_BYTES, MAX_ROUNDS, RC5_64_ALGO_NAME, RC5_64_BLOCK_BYTES, Rc5Params};

/// RC5-64 with 1- to 255-byte keys, 0 to 255 rounds and a 16-byte block.
///
...
/// use tc_rc5_v2::{Params, Rc564Engine, RC5_64_BLOCK_BYTES};
///
/// let key = [0x42; 16];
...
/// let mut encrypted = [0; RC5_64_BLOCK_BYTES];
