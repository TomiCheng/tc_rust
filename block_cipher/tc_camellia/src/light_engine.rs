...
/// use tc_camellia_v2::{BLOCK_BYTES, KEY_BYTES, CamelliaLightEngine};
///
...
impl CamelliaLightEngine {
    /// Creates an uninitialised light Camellia engine. Constant time.
...
impl fmt::Display for CamelliaLightEngine {
...
impl Drop for CamelliaLightEngine {
    fn drop(&mut self) {
...
impl<P: KeyParams + ?Sized> BlockCipherInit<P> for CamelliaLightEngine {
