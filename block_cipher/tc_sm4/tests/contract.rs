//! State, buffer and initialization contracts for the SM4 engine.

use tc_block_cipher::{
    BlockCipher, BlockCipherInit, BlockError, CipherDirection, InitError, KeyRef,
};
use tc_sm4_v2::{ALGO_NAME, BLOCK_BYTES, KEY_BYTES, Sm4Engine};
...
#[test]
fn the_sm4_engine_preserves_state_on_errors_and_processes_one_block_through_either_dispatch() {
    check_contract(Sm4Engine::new());
}

#[test]
fn a_default_sm4_engine_obeys_the_same_state_and_buffer_contract() {
    check_contract(Sm4Engine::default());
}
