...
/// Selects public round parameters. Constant time with respect to secrets.
...
/// Encrypts one block. Constant time: indices and rotations are public.
...
/// Decrypts one block. Constant time: indices and rotations are public.
