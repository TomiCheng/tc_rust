...
pub(crate) mod tea {
    ...
    /// Expands a key. Constant time with respect to key contents.
...
pub(crate) mod xtea {
    ...
    pub(crate) fn expand_key(key: &[u8; KEY_BYTES]) -> Schedule {
        ...
        for round in &mut schedule {
            // Each half selects a key word using different bits of the public sum.
...
mod tests {
    ...
    #[test]
    fn tea_recovers_the_plaintext_after_encrypting_with_the_same_key() {
    ...
    #[test]
    fn xtea_recovers_the_plaintext_after_encrypting_with_the_same_key() {
    ...
    #[test]
    fn tea_and_xtea_produce_different_ciphertexts_for_the_same_key_and_block() {
        // XTEA is not compatible with TEA.
