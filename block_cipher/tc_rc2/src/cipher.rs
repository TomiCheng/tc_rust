...
/// Variable time: key bytes index the PI table.
...
/// Encrypts one block. Variable time: mash rounds index subkeys with secret data.
...
/// Decrypts one block. Variable time: mash rounds index subkeys with secret data.
