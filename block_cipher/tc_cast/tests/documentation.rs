...
fn missing_timing_docs(source: &str) -> (usize, Vec<String>) {
    ...
    for line in source.lines().map(str::trim) {
        ...
        if engine_type
            ...
            || line.starts_with("pub(super) const ")
...
/// Variable time when indexed by secret data.
pub(super) const SBOX: [u32; 1] = [0];
...
fn every_engine_api_and_crate_visible_helper_has_an_unambiguous_timing_doc() {
    for (name, source) in [
        ("common.rs", include_str!("../src/common.rs")),
        ("cast5.rs", include_str!("../src/cast5.rs")),
        ("cast6.rs", include_str!("../src/cast6.rs")),
        ("cast5/cipher.rs", include_str!("../src/cast5/cipher.rs")),
        ("cast5/engine.rs", include_str!("../src/cast5/engine.rs")),
        ("cast5/tables.rs", include_str!("../src/cast5/tables.rs")),
        ("cast6/cipher.rs", include_str!("../src/cast6/cipher.rs")),
        ("cast6/engine.rs", include_str!("../src/cast6/engine.rs")),
    ] {
