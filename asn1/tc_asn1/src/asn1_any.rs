...
use crate::traits::{DecodeInner, Encode};
...
///
/// This type implements [`crate::Decode`], but not [`crate::DecodeContent`]: contents
/// alone do not supply the identifier or original header needed to preserve a TLV.
///
/// # Examples
///
/// ```
/// use tc_asn1::{Decode, Asn1Any, DecodeInner, DecodingOptions, Encode, EncodingOptions, EncodingType};
///
/// let saved = {
...
impl Asn1Any {
    ...
    ///
    /// ```
    /// use tc_asn1::{Decode, Asn1Any, DecodeInner, DecodingOptions};
    ...
    ///
    /// ```
    /// use tc_asn1::{Decode, Asn1Any, Asn1Boolean, DecodeInner, DecodingContext, DecodingOptions};
    ...
    /// assert!(view.decode_as::<Asn1Boolean>(&mut context)?.is_true());
...
impl From<&Asn1Ref<'_>> for Asn1Any {
    ...
    ///
    /// ```
    /// use tc_asn1::{Asn1Any, Asn1Ref, DecodingContext, DecodingOptions};
    /// let options = DecodingOptions::default();
    /// let mut context = DecodingContext::new(&options);
    /// let input = [0x30, 0x80, 5, 0, 0, 0];
    /// let view = Asn1Ref::parse(&input, &mut context)?;
...
impl<'a> DecodeInner<'a> for Asn1Any {
    ...
    ///
    /// ```
    /// use tc_asn1::{Decode, Asn1Any, Asn1Error, DecodeInner, DecodingOptions};
    /// let options = DecodingOptions::default();
...
impl<'a> crate::Decode<'a> for Asn1Any {
    fn decode(
        buff: &'a [u8],
...
impl crate::EncodeContent for Asn1Any {
    ...
    ///
    /// ```
    /// use tc_asn1::{Decode, Asn1Any, Asn1Error, DecodeInner, DecodingOptions, EncodeContent, EncodingOptions, EncodingType};
...
///
/// ```
/// use tc_asn1::{Decode, Asn1Any, DecodeInner, DecodingOptions, EncodeTagged, EncodingOptions, EncodingType};
...
mod tests {
    ...
    fn a_known_type_can_be_recovered_later_through_as_ref() {
        ...
        assert_eq!(
            any.as_ref()
                .decode_as::<Asn1Boolean>(&mut DecodingContext::new(&OPTIONS)),
